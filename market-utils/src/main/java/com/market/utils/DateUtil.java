...
public class DateUtil {
	...
	public static String dateToLongDateStr(Date date) throws Exception {
		if(date==null) {
			return"";
		}
	...
	public static String dateToLong2DateStr(Date date) throws Exception {
		if(date==null) {
			return "";
		}
	...
	public static String dateToDateStr(Date date) throws Exception {
		if(date==null) {
			return"";
		}
	...
	public static String dateToFileDate(Date date) throws Exception {
		if(date==null) {
			return"";
		}
		return fileSdf.format(date);
	}

	public static String dateToShortDate(Date date) throws Exception {
		if(date==null) {
			return"";
		}
	...
	public static String dateToShort2Date(Date date) throws Exception {
		if(date==null) {
			return"";
		}
		return short2Sdf.format(date);
	}
	public static String dateToShort3Date(Date date) throws Exception {
		if(date==null) {
			return"";
		}
		return short3Sdf.format(date);
	}
	public static String dateToShort4Date(Date date) throws Exception {
		if(date==null) {
			return"";
		}
	...
	public static String dateToShort5Date(Date date) throws Exception {
		if(date==null) {
			return"";
		}
	...
	public static String dateToShort6Date(Date date) throws Exception {
		if(date==null) {
			return"";
		}
